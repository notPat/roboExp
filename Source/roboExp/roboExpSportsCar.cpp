...
#include "roboExpSportsCar.h"
#include "roboExpSportsWheelFront.h"
#include "roboExpSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AroboExpSportsCar::AroboExpSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UroboExpSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UroboExpSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UroboExpSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UroboExpSportsWheelRear::StaticClass();
