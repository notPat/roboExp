...
#include "roboExpOffroadCar.h"
#include "roboExpOffroadWheelFront.h"
#include "roboExpOffroadWheelRear.h"
...
AroboExpOffroadCar::AroboExpOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UroboExpOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UroboExpOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UroboExpOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UroboExpOffroadWheelRear::StaticClass();
